...
function addPlatforms() {
  ...
  platforms.create(50, 550, 'platform2');
...
function createBadge() {
  ...
  var badge = badges.create(370, 270, 'badge');
...
function itemHandler(player, item) {
  ...
  if (currentScore >= winningScore) { // Use >= to cover potential higher scores
    createBadge();
    won = true; // Set the won flag
  }
}
...
window.onload = function () {
  ...
  // initial game set up
  function create() {
    player = game.add.sprite(150, 550, 'player');
...
function update() {
  ...
  player.body.velocity.x = 0;
    ...
    if (won) {
      winningMessage.text = "YOU'r WINNER!!!";
      game.stage.backgroundColor = '#07da63';
    }
  }
